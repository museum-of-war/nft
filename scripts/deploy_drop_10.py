...
def main():
    ...
    collection_name = "Meta History 10" # Collection name
    collection_symbol = "MH10" # Collection ticker
    mints_per_wallet = 50 # Maximum number of mints recommended per wallet (recommended 5-20)
    startTime = 1675591200 # TODO start time of sale
    withdrawAddress = "0xf9b6Ee27527c9D44D21c1ceA0D841440E2507Be4"
    metadata_cid = "QmRUUHN2GYCjM66phaGShDx7UWkpDFsvCegYn5zdmpbrzN" 

    # Deploy the MetaHistory contract
    drop_10 = SelectiveDropMHv2.deploy(
        price_eth * 10**18,
        NFTs_on_sale,
        max_copies,
        collection_name,
    ...
    print("Contract deployed at:", drop_10.address)

    if target_network == 'goerli':
        print("Airdrop...")
        drop_10.airdrop(list(range(1, 51)), deployer, { 'from': deployer })
